...
class Usereditcontroller extends CI_Controller
{
    ...
    function index()
    {
      ...
      $data['usrtype_result'] = $this->usermodel->usrtype();
        ...
        //print_r($data);$this->usermodel->useredit($userid);
...
/*
        try {
            ...
            $this->form_validation->set_rules('usrid','Userid','trim|required|alpha_numaric|min_length[1]|xss_clean');
